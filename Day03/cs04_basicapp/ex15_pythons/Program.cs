...
namespace ex15_pythons
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            paths.Add(@"C:\DEV-Roy\Langs\Python311"); // 기본 파이썬 경로
            paths.Add(@"C:\DEV-Roy\Langs\Python311\DLLs");
            paths.Add(@"C:\DEV-Roy\Langs\Python311\Lib");
            paths.Add(@"C:\DEV-Roy\Langs\Python311\Lib\site-packages");
            ...
            var filePath = @"C:\Sources\basic-csharp-2024\Day03\cs04_basicapp\ex15_pythons\Test.py";
